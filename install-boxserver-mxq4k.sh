...
main() {
  ...
  # Verificar se WireGuard foi instalado e adicionar info de gerenciamento
  if [[ $CHOICES == *"WIREGUARD"* ]]; then
    msg "WireGuard instalado! Use o script de gerenciamento:
    sudo $_BoxServer/scripts/wireguard-manager.sh menu
    "
  fi
